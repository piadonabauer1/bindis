...
"""
output = yolo_model(Image.open(img_path))
results = Detections.from_ultralytics(output[0]) # adjust for mutliple faces!
...
annotated_frame = box_annotator.annotate(scene= np.array(image).copy(), detections=detections)
